...
export default function TPOMessage() {
  return (
      ...
      >
        ...
        <div className="space-y-8 text-muted-foreground">
          ...
          >
            ...
            students from other states of India too.
          </motion.p>
          ...
          >
            ...
            students and students from remote places.
          </motion.p>
          ...
          <motion.p
            ...
            className="text-lg leading-relaxed"
          >
            Since assuming my additional charge as the Director of CIT Kokrajhar, I have
